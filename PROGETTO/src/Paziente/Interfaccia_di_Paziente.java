...
public class Interfaccia_di_Paziente extends JFrame implements ActionListener {
	...
	public Interfaccia_di_Paziente() {
	...
	public void actionPerformed(ActionEvent e) {
      ...
      if(c == 0)   {
     	 System.exit(0);}
     		...
     		Service_Pane_Paziente service_panel_paziente = new Service_Pane_Paziente();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
			panel3.add(service_panel_paziente.getPanelA(), BorderLayout.CENTER);
